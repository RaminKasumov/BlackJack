...
namespace BlackJack2022_3AHITN.Lib
{
    ...
    public class Game : IGame
    {
        ...
        /// </summary>
        public IPlayer Dealer => _table.Dealer;

        #endregion

        #region events
        public event EventHandler GameStarted = null!;

        public event EventHandler<PlayerEventArgs> PlayerActionPerformed = null!;

        public event EventHandler DealerActionPerformed = null!;

        public event EventHandler GameFinished = null!;

        public event EventHandler GameClosed = null!;
        #endregion
        ...
        /// </summary>
        /// <returns>Liefert Informationen über den Ablauf des Spiels zurück</returns>
        ...
        /// </summary>
        private void OnDealerActionPerformed()
        {
        ...
        /// </summary>
        private void OnPlayerActionPerformed(IPlayer player)
        {
